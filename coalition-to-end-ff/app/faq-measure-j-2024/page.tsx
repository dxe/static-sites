...
export const metadata: Metadata = {
  title: "FAQ - Measure J (obsolete)",
};

export default function FaqMeasureJ2024Page() {
  return (
    <>
      <PageHero title="FAQ" />
      ...
      <Section>
        <Accordion>
          ...
          <AccordionItem title="Who is funding the Yes on J campaign? Who is funding the opposition?">
            <p>
              The Yes on J campaign is funded by individual donors and
              charitable organizations passionate about improving the welfare
              of animals and protecting the environment. These donors have
              nothing to gain personally from this campaign other than the
              betterment of our world.
            </p>
            <p>
              The opposition, which has raised over $2.2 million dollars in
              order to keep CAFOs in Sonoma County, has received large
              donations from industry lobbying groups and factory farms
              across the country. They are set to outspend us 8-to-1.
            </p>
            <p>
              Their funding includes over $500,000 from Western United
              Dairies based in the Central Valley, $85,000 from the
              California Farm Bureau, $50,000 from the Agricultural Council
              of CA Issues PAC and another $50,000 from an associated
              committee, over $100,000 from various Farm Credits such as
              American AgCredit, $120,000 between Weber “Family” Farms and
              Sunrise Farms (which operates several large egg CAFOs in
              Sonoma County), $100,000 from Perdue’s Petaluma Poultry, $49,999
              from the National Pork Producers Council in Iowa and $25,000
              from the Iowa Pork Producers Association, $60,000 from Clover
              Sonoma (which spent over an additional $50,000 on independent
              advertising), $25,000 from the Sonoma Marin Cattleman’s
              Association, and tens of thousands more from associated farm
              bureaus and CAFOs.
            </p>
            <p>
              These entities are financially invested in the continuance of
              industrialized agriculture and are spending enormous amounts of
              money to quash the Yes on J campaign.
            </p>
            <p>
              You can see all campaign finance reports for all committees on
              the{" "}
              <a
                href="https://public.netfile.com/pub2/?AID=SON"
                target="_blank"
                rel="noopener"
                className="underline"
              >
                county’s public portal
              </a>
              .
            </p>
          </AccordionItem>
          ...
          <AccordionItem title="How would this impact small family farms?">
            <p>
              In fact, it would help small, local family farms. This
              ordinance would only prohibit industrialized factory farms that
              confine large numbers of animals, for example, farms with
              82,000 or more egg-laying chickens, 2,500 or more pigs, or 700
              or more cows, or farms that have been identified as significant
              contributors of pollutants. You can see the{" "}
              <a
                href="https://www3.epa.gov/npdes/pubs/sector_table.pdf"
                target="_blank"
                rel="noopener"
              ...
              . These massive factory farms often hurt small family farms.
              Small family farms cannot compete with industrial farming
              because factory farms externalize their costs onto animals,
              society, and the environment. This ordinance will help restore
              the local diverse agriculture that existed in Sonoma County
              before the factory farms moved in.
            </p>
          </AccordionItem>

          <AccordionItem title="What would happen to existing factory farms and workers?">
            <p>
              Existing factory farms would be given a 3-year phase-out period
              to scale down or phase out their operations. While many of us
              want to see factory farming end immediately, we understand
              that it takes time.
            </p>
            <p>
              The measure includes a provision that requires the county to
              provide a retraining and employment assistance program for
              people employed at CAFOs. This would ensure that they receive
              the training needed to work at another agricultural operation
              or in a different job sector. We hope to work with all relevant
              stakeholders, including labor groups, to ensure this retraining
              program meets the needs of workers and the community so that,
              together, we can evolve away from factory farming. Including
              workers in the transition plan is an important part of a just
              transition away from relying on factory farms.
            </p>
          </AccordionItem>

          <AccordionItem title="Has this been done before?">
            <p>
              Limiting or prohibiting CAFOs is not a unique idea. Legislation
              on this issue has been introduced or passed in states as
              diverse as Utah, Iowa, Wisconsin, Arkansas, and North Dakota.
              Federally, Senator Cory Booker has introduced the Farm Systems
              Reform Act that would place a moratorium on large CAFOs across
              the country. And just recently, voters in the City of Berkeley
              collected the requisite number of signatures to qualify a CAFO
              ban for the November 2024 ballot.
            </p>
          </AccordionItem>

          <AccordionItem title="When will this be voted on?">
            <p>
              Thanks to 150 volunteers who helped collect 37,000+ signatures,
              Measure J will be on the ballot November 5th.
            </p>
          </AccordionItem>
          ...
          <AccordionItem title="How can I volunteer?">
            <p>
              Check out our{" "}
