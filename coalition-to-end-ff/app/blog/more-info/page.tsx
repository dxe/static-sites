...
import satelliteImg from "@/public/images/blog__more-info/sunrise-main-sat-imagery.png";
import chickenCafoImg from "@/public/images/blog__more-info/petaluma-poultry-chicken-santa-rosa.png";
import duckCafoImg from "@/public/images/blog__more-info/reichardt-duck-cafo-in-petaluma.png";
import mertensCowsImg from "@/public/images/blog__more-info/mertens-dairy-cafo-900-cows-feedlot.png";
import mertensLagoonImg from "@/public/images/blog__more-info/mertens-manure-lagoon.jpg";

export const metadata: Metadata = {
  title: "More Info on Measure J",
};
      ...
      <div className="pt-28 md:mx-auto md:max-w-[360px] lg:mx-0 lg:max-w-none lg:pt-20">
        ...
        <div className="mt-10">
          <FigureImage
            src={satelliteImg}
            alt=""
            caption="Sunrise main satellite imagery"
        ...
        <p className="mt-5">
          ...
          poised to gut what remains of the USDA and EPA, it is becoming even
          more clear that local jurisdictions must lead the way when it
        ...
        <p className="mt-5">
          ...
          incentive to mechanize the process of livestock production in ways
          cruel to the animals, the farmers, and their communities.”
        </p>
        ...
        <p className="mt-5">
          ...
          have exposed a decade of extreme neglect, including diseased
          ducks left stuck on their backs, unable to get up, and
          consequently unable to reach food or water in violation of{" "}
          <a
          ...
          District Attorney&apos;s Office, the Sheriff’s Office, Animal Services,
          and local police departments, but time and time again, no action
          is taken and the abuse continues. Reichardt is the largest duck
          farm in California, confining over 200,000 ducks inside sheds
          where they live on wire flooring with no access to water for
          swimming, an important natural behavior.
        </p>
        ...
        <p className="mt-5">
          ...
          of California&apos;s animal cruelty laws at several Petaluma Poultry
          factory farms and the company’s slaughterhouse, including birds
          collapsed on the floor or stuck on their backs and unable to walk
          to food or water, left to slowly starve to death; birds with
        ...
        <p className="mt-5">
          ...
          genetically manipulates animals in ways that risk their health
          and wellbeing. Dairy cows and egg-laying hens are pushed to
          produce such high output that their bodies become exhausted after
          just a few years. In 1950, the average dairy cow produced around
          5,000 pounds of milk a year, but today, she produces almost
          20,000 pounds.” When their milk production declines around 5
          years of age, dairy cows are considered “spent” and sent to
          slaughter. In natural conditions, cows can live 20 to 25 years.
        </p>
        ...
        <div className="mt-10 space-y-6">
          <CollageImage
            src={mertensCowsImg}
            alt="Mertens Dairy CAFO in Sonoma with 900 cows living on a feedlot"
            caption="Mertens Dairy CAFO in Sonoma with 900 cows living on a feedlot"
            imagePosition="left"
          />
          <CollageImage
        ...
        <p className="mt-10">
          While the EPA is theoretically tasked with oversight of CAFO water
          pollution, a{" "}
          <a
          ...
          does not have comprehensive, accurate information on the number of
          permitted CAFOs nationwide. As a result, EPA does not have the
          ...
          task of challenging CAFOs has largely fallen on individuals such as
          environmental attorneys and activists. Last year two county CAFOs
          were sued over violations of the Clean Water Act; Reichardt Duck
          Farm settled the{" "}
          <a
        ...
        <h2 className="mt-12">Measure J will reduce greenhouse gas emissions.</h2>
        ...
        <h2 className="mt-12">Measure J will safeguard public health.</h2>
        ...
        <p className="mt-5">
          ...
          animals concentrated in confined areas, and often living on top of
          their own waste, CAFOs provide a perfect breeding ground for
          ...
          poses a serious risk of replicating the bird-to-cow-to-human
          jumps of H5N1 that have{" "}
          <a
        ...
        <p className="mt-5">
          ...
          taking over our food system, using monopolistic practices to push
          out small farms and control consumer pricing. This same process
          is also taking place in Sonoma County. There were over{" "}
          <a
        ...
        <p className="mt-5">
          ...
          called Green Goose Farm, says, &quot;Since the 1950&apos;s, industrial
          poultry CAFOs have been able to outcompete local family farms by
          using cheap transport and supply chains, minimal amounts of
          poorly paid labor, and by externalizing environmental costs.
          Cheap food has come at the cost of our local economy and rural
          landscape. The first step in rebuilding our food system, and
