...
import regulatoryDefinitionsImg from "@/public/images/what-are-cafos-1/regulatory-definitions-table.png";
import sizeThresholdsImg from "@/public/images/what-are-cafos-1/cafo-size-thresholds-table.png";
import facilityTableImg from "@/public/images/what-are-cafos-1/cafo-facility-table.jpg";

export const metadata: Metadata = {
  title: "What are CAFOs? (2024 Measure J version)",
};

export default function WhatAreCafos1Page() {
  return (
    <>
      ...
      <Section>
        <p>
          ...
          which are listed in the “Large CAFOs” section below. Under Measure
          J, these facilities would have three years to either close down,
          downsize or otherwise alter their operations to no longer meet the
          definition of a CAFO.
        </p>
        <p className="mt-5">
          Continue reading to understand how CAFOs are defined and the
          impact of Measure J on CAFOs.
        </p>
        ...
        <div className="mt-10 space-y-5">
          <h2 className="text-center">How Measure J Addresses CAFOs</h2>
          <p>
            Measure J would prohibit all CAFOs, including small, medium, and
            large CAFOs, though as explained above, there are no small or
            medium CAFOs in the county.
          </p>
          <p>
            Measure J would also prohibit new CAFOs from opening in Sonoma
            County, and it would prevent the expansion of existing CAFOs in
            the county during the three-year phase-out period. The measure
            would apply to unincorporated parts of the county, excluding the
            Coastal Zone.
          </p>
          <p>
          ...
          <p>
            ...
            that it no longer qualifies as a CAFO by the end of the
            three-year phase-out period in November 2027.
          </p>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              Stop confining the relevant number of animals for more than 45
              days per year so that the facility no longer qualifies as an
              AFO, and therefore cannot be a CAFO
            </li>
          </ul>
          <p>
            See the full{" "}
